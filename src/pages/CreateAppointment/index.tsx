...
interface AvailbailityItem {
  hour: number;
  available: boolean;
}

const CreateAppointment: React.FC = () => {
  const [availability, setAvailability] = useState<AvailbailityItem[]>([]);
  ...
  const [selectedProvider, setSelecetedProvider] = useState(
  ...
  const handleSelecProvider = useCallback((providerId: string) => {
    setSelecetedProvider(providerId);
  }, []);
